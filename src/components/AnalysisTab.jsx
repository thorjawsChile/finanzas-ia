...
import { CAT_COLORS, PALETTE, fmt } from "../constants.js";
import { Card, KpiCard, CustomTooltip } from "./ui/Card.jsx";

/* ── ANALYSIS TAB ────────────────────────────────────────────────────── */
export function AnalysisTab({ analysis, budget, setBudget }) {
  if (!analysis) {
    return (
    ...
    <div className="space-y-5">
      ...
      <Card>
        ...
        <ResponsiveContainer width="100%" height={220}>
          <PieChart>
            <Pie data={pieData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={80} innerRadius={42} paddingAngle={1} minAngle={4}
