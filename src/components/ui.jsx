...
export function DropZone({ onFile, accept = ".pdf,.csv,.txt", label, sublabel, fileName, loading, progress }) {
  ...
  return (
    <div
      ...
      className={`border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-all ${dragging ? "border-violet-500 bg-violet-950/20" : "border-slate-700/60 hover:border-violet-600/50 hover:bg-white/5"}`}
    >
